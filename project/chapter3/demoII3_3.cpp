...
#define WINDOW_CLASS_NAME TEXT("WIN3DCLASS")  // class name
     ...
     case WM_COMMAND:
         {
          switch(LOWORD(wparam))
                ...
                case MENU_HELP_ABOUT:                 
                     ...
                     MessageBox(hwnd, TEXT("Menu MIDI Demo"), 
                               TEXT("About MIDI Menu"),
                ...
                case MENU_PLAY_ID_9:
					 ...
					 wchar_t *wbuffer = ConvertW(buffer, CP_ACP);
                     // draw the midi file
                     TextOut(hdc,8,200, wbuffer, wcslen(wbuffer));
                ...
                case MENU_PLAY_ID_13:
                     ...
                     // draw the midi file
					 wchar_t *wbuffer = ConvertW(buffer, CP_ACP);
					 TextOut(hdc,8,216, wbuffer, wcslen(wbuffer));
...
winclass.lpszMenuName	= TEXT("SoundMenu");
...
if (!(hwnd = CreateWindowEx(NULL,                  // extended style
						    ...
						    TEXT("DirectMusic/DirectSound Mixed Mode Demo"), // title
